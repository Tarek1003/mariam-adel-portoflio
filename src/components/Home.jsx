...
const Home = () => {
  return (
    <main className='relative min-h-screen overflow-hidden bg-black px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20' id="home">
      <BackgroundBeams />

      <div className='relative z-10 flex flex-col-reverse max-sm:flex-col-reverse lg:flex-row  min-h-screen items-center lg:justify-between justify-center gap-5 '>
